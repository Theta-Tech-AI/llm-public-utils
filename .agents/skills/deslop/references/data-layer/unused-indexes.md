...
In relation to other principles, dropping unused indexes:

| Principle | Relationship |
|-----------|--------------|
| [**Index What You Filter, Join, and Sort On**](index-access-columns.md) | Bidirectional — a hot predicate needs an index, a cold index needs a drop |
| [**YAGNI**](../clean-code/yagni.md) | An index serving no query is speculative generality |
