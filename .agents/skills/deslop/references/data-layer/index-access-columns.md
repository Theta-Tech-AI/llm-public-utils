...
In relation to other principles, indexing access columns:

| Principle | Relationship |
|-----------|--------------|
| [**Match the Index to the Query Shape**](index-query-shape.md) | Which columns is half the job; what shape is the other half |
| [**Every Index Is Used or It's Dropped**](unused-indexes.md) | The same discipline in reverse — no orphan indexes |
